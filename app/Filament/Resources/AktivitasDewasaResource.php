...
use App\Filament\Resources\AktivitasDewasaResource\Pages;
...
class AktivitasDewasaResource extends Resource
{
    protected static ?string $model = AktivitasDewasa::class;

    protected static ?string $navigationIcon = 'heroicon-o-briefcase';
    protected static ?string $navigationGroup = 'Program Aktivitas';
    protected static ?string $label = 'Aktivitas Dewasa';
    ...
    {
        return [
            'index' => Pages\ListAktivitasDewasas::route('/'),
            'create' => Pages\CreateAktivitasDewasa::route('/create'),
            'edit' => Pages\EditAktivitasDewasa::route('/{record}/edit'),
        ];
    }    
}
